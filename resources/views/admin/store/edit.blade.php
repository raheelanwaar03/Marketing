                        ...
                        <div class="card-body">
                            <form action="{{ route('Admin.Update.Store', ['id' => $store->id]) }}" method="POST"
                                ...
                                <div class="form-group my-3">
                                    ...
                                    <input type="text" name="store_slug" value="{{ $store->store_name }}"
                                        class="form-control" placeholder="Enter Store Slug">
                                </div>
                                <div class="form-group my-3">
                                    <label for="" class="mb-1 ml-2">Store Description</label>
                                    <textarea name="store_des" id="" cols="30" rows="10">{{ $store->store_des }}</textarea>
                                </div>
                                <div class="form-group my-3">
                                    <label for="" class="mb-1 ml-2">Store Country</label>
                                    <input type="text" name="store_country" value="{{ $store->store_country }}"
                                        class="form-control">
                                </div>
                                <div class="form-group my-3">
                                    <label for="" class="mb-1 ml-2">Store Network</label>
                                    <input type="text" name="store_network" value="{{ $store->store_network }}"
                                        class="form-control">
                                </div>
                                <div class="form-group my-3">
                                    <label for="" class="mb-1 ml-2">Store link</label>
                                    <input type="text" name="store_link" value="{{ $store->store_link }}"
                                        class="form-control">
                                </div>
                                <div class="form-check my-3">
                                    <label for="" class="form-check-label mb-1 ml-2">Hide</label>
                                    <input type="checkbox" name="status" {{ $store->status == '1' ? 'checked' : '' }}
                                        class="form-check-input">
                                </div>
                                <div class="form-group my-3">
                                    <label for="" class="mb-1 ml-2">Store Image</label>
                                    <input type="file" name="store_img" value="{{ $store->store_img }}"
                                        class="form-control">
                                </div>
                                <div class="my-3">
                                    <img src="{{ asset('images/' . $store->store_img) }}" alt="store img" height="80px"
                                        width="80px">
                                </div>
