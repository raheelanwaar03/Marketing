            ...
            <div class="row grid-coupons">
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="coupon-list">
                        <div class="coupon-wrapper">
                            <div class="post-media">
                                <a href="coupon-single.html"><img src="{{ asset('assets/uploads/store_01.jpg') }}"
                                        alt="" class="img-responsive"></a>
                            </div><!-- end media -->
                            ...
                            <div class="coupon-bottom clearfix">
                                ...
                                <small class="pull-right"><a href="store-single.html"><i class="fa fa-comment-o"></i>
                                        65</a></small>
                            </div><!-- end coupon-top -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="coupon-list">
                        <div class="coupon-wrapper">
                            <div class="post-media">
                                <a href="coupon-single.html"><img src="{{ asset('assets/uploads/store_02.jpg') }}"
                                        alt="" class="img-responsive"></a>
                            </div><!-- end media -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="coupon-list">
                        <div class="coupon-wrapper">
                            <div class="post-media">
                                <a href="coupon-single.html"><img src="{{ asset('assets/uploads/store_03.jpg') }}"
                                        alt="" class="img-responsive"></a>
                            </div><!-- end media -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="coupon-list">
                        <div class="coupon-wrapper">
                            <div class="post-media">
                                <a href="coupon-single.html"><img src="{{ asset('assets/uploads/store_04.jpg') }}"
                                        alt="" class="img-responsive"></a>
                            </div><!-- end media -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="coupon-list">
                        <div class="coupon-wrapper">
                            <div class="post-media">
                                <a href="coupon-single.html"><img src="{{ asset('assets/uploads/store_05.jpg') }}"
                                        alt="" class="img-responsive"></a>
                            </div><!-- end media -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="coupon-list">
                        <div class="coupon-wrapper">
                            <div class="post-media">
                                <a href="coupon-single.html"><img src="{{ asset('assets/uploads/store_06.jpg') }}"
                                        alt="" class="img-responsive"></a>
                            </div><!-- end media -->
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="coupon-list">
                        <div class="coupon-wrapper">
                            <div class="post-media">
                                <a href="coupon-single.html"><img src="{{ asset('assets/uploads/store_07.jpg') }}"
                                        alt="" class="img-responsive"></a>
                            </div><!-- end media -->
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <a href="store-single.html"><img
                                                        src="{{ asset('assets/uploads/store_07.jpg') }}" alt=""
                                                        class="img-responsive"></a>
                                                <div class="modal-button">
                                                    <a href="http://themeforest.net/" target="_blank" title=""
                                                        class="btn btn-default btn-block">Visit
                ...
                <div class="col-md-3 col-sm-6 col-xs-12">
                    <div class="coupon-list">
                        <div class="coupon-wrapper">
                            <div class="post-media">
                                <a href="coupon-single.html"><img src="{{ asset('assets/uploads/store_08.jpg') }}"
                                        alt="" class="img-responsive"></a>
                            </div><!-- end media -->
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <a href="store-single.html"><img
                                                        src="{{ asset('assets/uploads/store_08.jpg') }}" alt=""
                                                        class="img-responsive"></a>
                                                <div class="modal-button">
                                                    <a href="http://themeforest.net/" target="_blank" title=""
                                                        class="btn btn-default btn-block">Visit
                                            ...
                                            <div class="showcode row">
                                                ...
                                                <div class="col-md-8 text-center">
                                                    <button data-clipboard-text="1INVITEFRI"
                                                        class="coupon-code btn btn-primary btn-block" type="submit"
                                                        title="Click to Copy">1INVITEFRI</button>
                                                    <small>Click to Copy</small>
                                                </div>
                                            </div><!-- end row -->
                                        </div><!-- end coupon-area -->
