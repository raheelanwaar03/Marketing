                ...
                <div class="col-md-12">
                    @forelse ($coupons as $coupon)
                        <div class="col-md-6 col-sm-6 col-xs-12 service-column service4-column">
                            <span class="service4-icons icons" style="border: 1px solid rgb(76, 91, 228);height:300px">
                                <h2>{{ $coupon->coupon_text }}</h2>
                            </span>
                            <div class="service4-desc" style="min-height: 200px;">
                                <h5>{{ $coupon->coupon_name }}</h5>
                                <p class="line-height26 marbtm20">{{ $coupon->coupon_des }}
                                </p>
